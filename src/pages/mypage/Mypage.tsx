    ...
    <Container>
      <Content>
        ...
        <TopBar>
          ...
          <ButtonWrap>
            <FeatureButton onClick={() => router('/friend')}>
              <img src={UserAdd} alt="유저추가" />
              <p>친구 추가</p>
            </FeatureButton>
            <FeatureButton onClick={() => router('edit')}>
              <img src={EditPencil} alt="편집" />
              <p>편집</p>
            </FeatureButton>
          </ButtonWrap>
        </TopBar>
        ...
        <FriendContent>
          ...
          {hasNextPage && !friendLoading && <ScrollObserver ref={ref} />}
