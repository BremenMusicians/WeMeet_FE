  ...
  return (
    <Container>
      <Content>
        ...
        {roomOpen && (
          <Modal onClick={() => createRoom({ ...createData, maxMember: participants })} onClose={() => setRoomOpen(false)}>
            <ModalContent>
              <ModalTitleWrap>
              ...
              <RadioWrap>
                ...
                <CustomRadioComponents name="roomType" id="private" value="private" label="비공개" checked={isPrivate} onChange={() => setIsPrivate(true)} />{' '}
              </RadioWrap>
              {isPrivate && (
                <ContentWrap>
                  <p>
